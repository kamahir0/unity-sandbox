...
namespace ScreenManagementSample.Presentation
{
    ...
    public class SkillSelectView : MonoBehaviour
    {
        ...
        /// <summary>
        /// スキルボタンを動的に生成（スタガーアニメーション付き）
        /// </summary>
        public void SetSkills(Skill[] skills, Action<Skill> onSkillSelected)
        {
            ClearSkillButtons();
            ...
            {
                var skill = skills[i];
                var button = Instantiate(_skillButtonPrefab, _buttonContainer);
                ...
                button.onClick.AddListener(() =>
                {
                    ...
                    button.transform
                        ...
                        .SetLink(button.gameObject)
                        .OnComplete(() => onSkillSelected?.Invoke(capturedSkill));
                });
